...
export default function Home() {
  return (
    <div className="mx-auto flex w-full max-w-[988px] flex-1 flex-col items-center justify-center gap-2 p-4 lg:flex-row">
      ...
      <div className="flex max-w-[480px] flex-col items-center gap-y-8 text-center text-neutral-600">
        <h1 className="text-xl font-bold lg:text-3xl">Learn, practice, and master new languages with Lingo. </h1>
